...
var html = '<div class="row" style="margin-right: 15px;margin-left: 15px;margin-top: 30px">'+
            '<div class="col" style="max-width: 30%;"><text font-size:16px> ' + playerName + ' </text>  <img data-toggle="tooltip" title="' + playerName + '"style="height:200px" src = "' + filteredData[0]["imgURL"] +'"></img> </div>'+
